...
public class MemberController {
	...
	@GetMapping("/memInfo") //회원상세페이지
	public String memInfo(@RequestParam(value="id") String id,Model model) {
		log.info("id : "+id);
		MemberDto memberDto = memberService.findById(id);
		model.addAttribute("mdto",memberDto);
		model.addAttribute("data","<div>안녕하세요.</div>");
		return "memInfo";
	}
	...
	public String memDelete(@RequestParam(value="id") String id) {
